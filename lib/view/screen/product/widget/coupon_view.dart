...
class CouponView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(Strings.coupon_voucher, style: robotoBold),
      SizedBox(height: 10),
            ...
            child: Center(
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Text(Strings.grab_now, style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                ),
              ),
            ),
          ),
